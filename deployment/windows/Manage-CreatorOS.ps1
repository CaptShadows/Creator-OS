...
switch ($Action) {
    ...
    "Stop" { Stop-CreatorOSApp $DataRoot (Resolve-Path (Join-Path $PSScriptRoot "..\..")) }
    "Restart" { Stop-CreatorOSApp $DataRoot (Resolve-Path (Join-Path $PSScriptRoot "..\..")); Start-Sleep -Seconds 2; Start-ScheduledTask -TaskName "CreatorOS-App" }
