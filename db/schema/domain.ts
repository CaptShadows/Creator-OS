...
export const samples = pgTable("samples", {
  ...
  sourcePlatform: text("source_platform"), status: sampleStatus("status").default("requested").notNull(), requestedAt: timestamp("requested_at", { withTimezone: true }), approvedAt: timestamp("approved_at", { withTimezone: true }), shippedAt: timestamp("shipped_at", { withTimezone: true }), receivedAt: timestamp("received_at", { withTimezone: true }), trackingReference: text("tracking_reference"), notes: text("notes"), ...timestamps,
