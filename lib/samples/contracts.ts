...
export const productEditSchema=z.object({productId:z.uuid(),name:z.string().trim().min(1).max(300),category:optionalText,notes:optionalText,priority:z.enum(["low","medium","high"]),active:z.enum(["true","false"]).transform(v=>v==="true")});
